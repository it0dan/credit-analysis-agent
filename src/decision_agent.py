...
def load_decision_prompt() -> str:
    ...
    return (
        ...
        "   - Pré-Aprovação Automática (PreApproved): Se tudo estiver regularizado: compliance ok, risk_tier \"low\", sem restrições de bureau e renda confirmada compatível. Este é o resultado de uma análise automática e NÃO representa liberação final de crédito.\n\n"
